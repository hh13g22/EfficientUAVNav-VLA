...
class EpisodeController:
    ...
    def setup_episode(self):
        ...
        # Load reference images from disk (Disabled for saving disk space)
        """
        ...
        # Instead loaf refernece images by inferencing the simulator with the starting coordinates
